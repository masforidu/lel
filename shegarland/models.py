...
class ShegarLandForm(models.Model):
    ...
    Aanaa_choices = [
        ...
        ('Galaan Arabsaa', 'Galaan Arabsaa'), ('Galaan Goraa', 'Galaan Goraa'),
        ('Faccee', 'Faccee'), ('Siidaa awaash', 'Siidaa awaash'),
    ...
    balina_lafa = models.DecimalField(max_digits=10, decimal_places=3, default=0.0)
    ...
    bal_lafa_bahi_tae = models.DecimalField(max_digits=10, decimal_places=3, default=0.0)
    bal_lafa_hafe = models.DecimalField(max_digits=10, decimal_places=3, default=0.0)
